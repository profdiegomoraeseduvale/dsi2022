                  ...
                  <div class="col-auto background">               
                    ...
                    <?php if(isset($_GET['erro'])){ ?>
                      <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Atenção</strong> E-mail ou senha incorretos.
                    ...
                    <?php }?>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="password" class="form-control inputvalor" id="senha" name="senha" placeholder="Digite sua senha" required>
                      </div>    
